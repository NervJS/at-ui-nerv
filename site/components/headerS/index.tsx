      ...
      <header className={classnames('page-header', { collapse })} id='J-page-header'>
        <div className='nav-container'>
          ...
          <div className='nav-right'>
            <ul className='navbar'>
              <li>
                <a href='https://at-ui.github.io/at-ui/#/zh/guide/color' activeClassName='router-link-active' >
                  指南
                </a>
              </li>
              <li>
              ...
              <li>
                <a activeClassName='router-link-active' href='https://at-ui.github.io/at-ui/#/zh/resource/design'>
                  资源
                </a>
              </li>
            </ul>
